	...
	<view class="content">
		<view :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
			...
			<view :style='{"width":"100%","background":"#fff","height":"auto"}'>
				...
				<!-- 样式2 -->
				<view class="news-box2" :style='{"width":"100%","padding":"24rpx","margin":"0","flexWrap":"wrap","display":"flex","height":"auto"}'>
					<block v-for="(product,index) in list" :key="index">
					  <view @tap="onDetailTap(product)" v-if="index==0" class="list-item" :style='{"padding":"0","margin":"20rpx 0","display":"none","width":"100%","position":"relative","height":"288rpx","order":"1"}'>
						<image :style='{"width":"100%","objectFit":"cover","borderRadius":"10rpx 0 0 10rpx","display":"block","height":"100%"}' mode="aspectFill" class="listmpic" :src="baseUrl+product.picture"></image>
						<view :style='{"padding":"40rpx 20rpx","margin":"0","backgroundColor":"rgba(190, 176, 167,.8)","overflow":"hidden","color":"#fff","borderRadius":"0 20rpx 20rpx 0","textAlign":"center","width":"20%","lineHeight":"72rpx","fontSize":"56rpx","zIndex":"1"}' class="title ">{{product.title}}</view>
					  </view>
					  <view @tap="onDetailTap(product)" v-if="index>0" class="list-item" :style='{"width":"100%","margin":"10rpx 0","background":"rgba(190, 176, 167,.2)","height":"auto"}'>
						<view :style='{"padding":"0 20rpx","borderColor":"rgba(153, 153, 153,.5)","color":"#666","borderWidth":"0 0 4rpx 0","width":"100%","lineHeight":"88rpx","fontSize":"28rpx","borderStyle":"solid"}' class="title ">{{product.title}}</view>
					  </view>
					</block>
				</view>
