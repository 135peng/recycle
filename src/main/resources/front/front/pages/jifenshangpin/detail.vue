...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
				...
				<view :style='{"margin":"0 0 24rpx 0","borderColor":"#ccc","borderWidth":"0 0 4rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"center","background":"0","width":"160rpx","lineHeight":"80rpx","fontSize":"28rpx"}' class="lable">兑换积分：</view>
					<view :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' class="text">{{detail.duihuanjifen}}</view>
				</view>
				...
				<view class="detail-list-item" :style='{"margin":"0 0 24rpx 0","borderColor":"#ccc","borderWidth":"0 0 4rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"center","background":"0","width":"160rpx","lineHeight":"80rpx","fontSize":"28rpx"}'>兑换规则</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.duihuanguize}}</view>
				</view>
				...
				<view class="detail-list-item rich" :style='{"margin":"0 0 24rpx 0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>商品介绍</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"width":"100%","padding":"10rpx 24rpx","flexWrap":"wrap","background":"#ccc","display":"flex","height":"auto"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"20rpx","color":"rgb(255, 255, 255)","background":"#999","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="userid&&isAuth('jifenshangpin','兑换')" @tap="onAcrossTap('jifenduihuan','','','')" class="cu-btn bg-brown round shadow-blur" >兑换</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"20rpx","color":"rgb(255, 255, 255)","background":"#999","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('jifenshangpin','兑换')" @tap="onAcrossTap('jifenduihuan','','','')" class="cu-btn bg-brown round shadow-blur" >兑换</button>
				</view>
			</view>
...
<script>
	export default {
		...
		async onShow(options) {
			...
			this.getStoreup();
			let cleanType = uni.getStorageSync('discussjifenshangpinCleanType')
			if(cleanType){
		...
		methods: {
			...
			async upCallback(mescroll) {
                let res = await this.$api.list('discussjifenshangpin', {
					page: mescroll.num,
					limit: 10,
					refid: this.id
				});
			...
			// 添加评论
			async onCommentTap() {
				this.$utils.jump(`../discussjifenshangpin/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
