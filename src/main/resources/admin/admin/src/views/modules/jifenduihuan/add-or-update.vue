<template>
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="兑换编号" prop="duihuanbianhao">
					<el-input v-model="ruleForm.duihuanbianhao" placeholder="兑换编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.duihuanbianhao" label="兑换编号" prop="duihuanbianhao">
					<el-input v-model="ruleForm.duihuanbianhao" placeholder="兑换编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="upload" v-if="type!='info' && !ro.shangpintupian" label="商品图片" prop="shangpintupian">
					<file-upload
						tip="点击上传商品图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="upload" v-else-if="ruleForm.shangpintupian" label="商品图片" prop="shangpintupian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="数量" prop="shuliang">
					<el-input v-model="ruleForm.shuliang" placeholder="数量" clearable  :readonly="ro.shuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="数量" prop="shuliang">
					<el-input v-model="ruleForm.shuliang" placeholder="数量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="兑换积分" prop="duihuanjifen">
					<el-input v-model="ruleForm.duihuanjifen" placeholder="兑换积分" clearable  :readonly="ro.duihuanjifen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="兑换积分" prop="duihuanjifen">
					<el-input v-model="ruleForm.duihuanjifen" placeholder="兑换积分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="合计积分" prop="jifen">
					<el-input v-model="jifen" placeholder="合计积分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jifen" label="合计积分" prop="jifen">
					<el-input v-model="ruleForm.jifen" placeholder="合计积分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="兑换时间" prop="duihuanshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.duihuanshijian" label="兑换时间" prop="duihuanshijian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="积分" prop="yonghujifen">
					<el-input v-model="ruleForm.yonghujifen" placeholder="积分" clearable  :readonly="ro.yonghujifen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="积分" prop="yonghujifen">
					<el-input v-model="ruleForm.yonghujifen" placeholder="积分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="积分" prop="jf">
					<el-input v-model="ruleForm.jf" placeholder="积分" clearable  :readonly="ro.jf"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="积分" prop="jf">
...
export default {
	...
	computed: {
		...
		jifen:{
			get: function () {
				return 1*this.ruleForm.shuliang*this.ruleForm.duihuanjifen
			}
		},
    ...
    // 提交
    onSubmit() {
		if(this.ruleForm.duihuanbianhao) {
			this.ruleForm.duihuanbianhao = String(this.ruleForm.duihuanbianhao)
		}
	...
	if(this.ruleForm.shangpintupian!=null) {
      ...
      if(parseFloat(this.ruleForm.duihuanjifen)>parseFloat(this.ruleForm.yonghujifen)){
